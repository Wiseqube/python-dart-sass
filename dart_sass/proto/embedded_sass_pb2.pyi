...
class InboundMessage(_message.Message):
    ...
    class CompileRequest(_message.Message):
        __slots__ = ("string", "path", "style", "source_map", "importers", "global_functions", "alert_color", "alert_ascii", "verbose", "quiet_deps", "source_map_include_sources", "charset")
        ...
        class Importer(_message.Message):
            __slots__ = ("path", "importer_id", "file_importer_id", "non_canonical_scheme")
            ...
            def __init__(self, path: _Optional[str] = ..., importer_id: _Optional[int] = ..., file_importer_id: _Optional[int] = ..., non_canonical_scheme: _Optional[_Iterable[str]] = ...) -> None: ...
    ...
    class CanonicalizeResponse(_message.Message):
        ...
        url: str
        error: str
        def __init__(self, id: _Optional[int] = ..., url: _Optional[str] = ..., error: _Optional[str] = ...) -> None: ...
    ...
    class FileImportResponse(_message.Message):
        ...
        file_url: str
        error: str
        def __init__(self, id: _Optional[int] = ..., file_url: _Optional[str] = ..., error: _Optional[str] = ...) -> None: ...
...
class OutboundMessage(_message.Message):
    ...
    class LogEvent(_message.Message):
        __slots__ = ("type", "message", "span", "stack_trace", "formatted")
        ...
        stack_trace: str
        formatted: str
        def __init__(self, type: _Optional[_Union[LogEventType, str]] = ..., message: _Optional[str] = ..., span: _Optional[_Union[SourceSpan, _Mapping]] = ..., stack_trace: _Optional[str] = ..., formatted: _Optional[str] = ...) -> None: ...
...
class Value(_message.Message):
    __slots__ = ("string", "number", "rgb_color", "hsl_color", "list", "map", "singleton", "compiler_function", "host_function", "argument_list", "hwb_color", "calculation", "compiler_mixin")
    ...
    class HslColor(_message.Message):
        __slots__ = ("hue", "saturation", "lightness", "alpha")
        ...
        lightness: float
        alpha: float
        def __init__(self, hue: _Optional[float] = ..., saturation: _Optional[float] = ..., lightness: _Optional[float] = ..., alpha: _Optional[float] = ...) -> None: ...
    class HwbColor(_message.Message):
        __slots__ = ("hue", "whiteness", "blackness", "alpha")
        HUE_FIELD_NUMBER: _ClassVar[int]
        WHITENESS_FIELD_NUMBER: _ClassVar[int]
        BLACKNESS_FIELD_NUMBER: _ClassVar[int]
        ALPHA_FIELD_NUMBER: _ClassVar[int]
        hue: float
        whiteness: float
        blackness: float
        alpha: float
        def __init__(self, hue: _Optional[float] = ..., whiteness: _Optional[float] = ..., blackness: _Optional[float] = ..., alpha: _Optional[float] = ...) -> None: ...
    ...
    HSL_COLOR_FIELD_NUMBER: _ClassVar[int]
    ...
    HWB_COLOR_FIELD_NUMBER: _ClassVar[int]
    CALCULATION_FIELD_NUMBER: _ClassVar[int]
    COMPILER_MIXIN_FIELD_NUMBER: _ClassVar[int]
    string: Value.String
    number: Value.Number
    rgb_color: Value.RgbColor
    hsl_color: Value.HslColor
    list: Value.List
    map: Value.Map
    ...
    hwb_color: Value.HwbColor
    calculation: Value.Calculation
    compiler_mixin: Value.CompilerMixin
    def __init__(self, string: _Optional[_Union[Value.String, _Mapping]] = ..., number: _Optional[_Union[Value.Number, _Mapping]] = ..., rgb_color: _Optional[_Union[Value.RgbColor, _Mapping]] = ..., hsl_color: _Optional[_Union[Value.HslColor, _Mapping]] = ..., list: _Optional[_Union[Value.List, _Mapping]] = ..., map: _Optional[_Union[Value.Map, _Mapping]] = ..., singleton: _Optional[_Union[SingletonValue, str]] = ..., compiler_function: _Optional[_Union[Value.CompilerFunction, _Mapping]] = ..., host_function: _Optional[_Union[Value.HostFunction, _Mapping]] = ..., argument_list: _Optional[_Union[Value.ArgumentList, _Mapping]] = ..., hwb_color: _Optional[_Union[Value.HwbColor, _Mapping]] = ..., calculation: _Optional[_Union[Value.Calculation, _Mapping]] = ..., compiler_mixin: _Optional[_Union[Value.CompilerMixin, _Mapping]] = ...) -> None: ...
